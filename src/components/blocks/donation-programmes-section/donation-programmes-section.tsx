...
const newProgrammes: Programme[] = [
  {
    ...
    description: 'Organising community blood drives to ensure a steady, safe supply for mothers and newborns requiring emergency transfusions during and after childbirth.',
  },
  {
    ...
    description: 'Providing counselling sessions, peer support groups, and community-based care to help mothers navigate postpartum depression, anxiety, and emotional burnout.',
  },
  {
    ...
    description: 'Equipping children aged 0–6 with foundational learning through play-based programmes, trained caregivers, and access to educational materials.',
  },
  {
    ...
    description: 'Supporting children with disabilities through adaptive care, therapy referrals, caregiver training, and advocacy for inclusive education and dignity.',
  },
]

const ProgrammeCard = ({ programme, imageHeight }: { programme: Programme; imageHeight: string }) => (
  <div className="flex flex-col rounded-3xl border border-border bg-card overflow-hidden hover:shadow-md transition-shadow duration-300">
    ...
    <div className="flex flex-col gap-3 p-5">
      <Badge variant="outline" className="w-fit text-xs font-normal px-3 py-1 rounded-full">
        {programme.category}
      </Badge>
